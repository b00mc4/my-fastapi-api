...
@router.post("",status_code=201,summary="สร้างสินค้า")
...
@router.get("", summary="สินค้าทั้งหมด")
...
@router.get("/{uuid_product}",summary="ค้นหาสินค้า(UUID)")
...
@router.put("/{uuid_product}",status_code=200,summary="เปลี่ยนข้อมูลสินค้า")
...
@router.patch("/{uuid_product}/stock", summary="แก้ไข stock สินค้า")
...
@router.delete("/{uuid_product}",status_code=200,summary="ลบสินค้า")
...
@router.post("/{uuid_product}/image", summary="อัปโหลดรูปภาพสินค้า")
...
@router.put("/{uuid_product}/image", summary="อัปเดตรูปภาพสินค้า")
...
@router.delete("/{uuid_product}/image", summary="ลบรูปภาพสินค้า")
